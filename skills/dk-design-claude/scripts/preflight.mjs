...
const RECEIPT_SCHEMA = 'axion-claude-skill-install/v1';
...
function copiedRuntime() {
  ...
  if (requestedRoot !== realpathSync(repository)) {
    return { status: 'invalid', repository, issue: 'preflight --cwd must match the repository that owns .claude/skills/dk-design' };
  }
...
const result = {
  schema: 'axion-claude-preflight/v1',
